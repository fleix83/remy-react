...
const PostEditModal: React.FC<PostEditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-0 md:p-4 z-40">
      <div className="post-editor-surface w-full h-full md:rounded-lg md:max-w-4xl md:max-h-[90vh] md:h-auto overflow-y-auto hide-scrollbar-desktop" style={{ '--editor-cat-tint': editorTint ?? undefined } as React.CSSProperties}>
        <div className="px-4 md:px-6 pb-0 pt-[120px] md:pt-[35px]">
          <button
            onClick={onClose}
            className="fixed md:absolute z-10 text-[var(--primary)] hover:text-[#3b71e6] transition-colors p-1.5 md:p-1 rounded-full bg-white/70 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none top-[44px] right-[28px] md:top-[50px] md:right-[50px]"
          >
          ...
          <h2 className="font-headline font-bold text-left mb-1 md:mb-0" style={{ color: '#4785ff', fontSize: '20px' }}>
            Beitrag bearbeiten
          </h2>
        </div>
