    ...
    <div className="relative">
      ...
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg bg-white focus:outline-none focus:border-[var(--primary)] disabled:bg-gray-100 disabled:text-gray-500"
        />
            ...
            filteredTherapists.map((therapist, index) => {
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="font-semibold text-[#3b71e6]">
