  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        disabled={disabled}
        className={`
          inline-flex items-center px-3 py-2 w-full justify-between
          transition-[transform,opacity] duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500
          rounded-lg text-base
          ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:opacity-80 active:opacity-60 active:scale-[0.98]'}
          ${badgeClassName}
        `}
        style={style}
