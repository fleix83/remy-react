...
const LANDING_FEATURES = [
  ...
  },
  {
    ...
    blob: `<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#89A9FF" d="M41.7,-68.3C53.6,-61.4,62.4,-49.5,68.9,-36.3C75.4,-23.1,79.6,-8.6,77.6,5C75.6,18.6,67.4,31.3,57.4,42.4C47.4,53.5,35.6,63,21.9,68.7C8.2,74.4,-7.4,76.3,-22.1,72.5C-36.8,68.7,-50.6,59.2,-60.3,46.5C-70,33.8,-75.6,17.9,-75.9,1.6C-76.2,-14.7,-71.2,-31.4,-61.1,-43.9C-51,-56.4,-35.8,-64.7,-20.9,-70.7C-6,-76.7,8.6,-80.4,22.6,-77.4C36.6,-74.4,29.8,-75.2,41.7,-68.3Z" transform="translate(100 100)"/></svg>`,
  ...
  },
  {
    ...
    blob: `<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#A7C0FF" d="M36.8,-60.9C48.6,-53.7,59.4,-44.1,66.3,-31.9C73.2,-19.7,76.2,-4.9,73.4,8.6C70.6,22.1,62,34.3,51.4,44.8C40.8,55.3,28.2,64.1,13.7,69.2C-0.8,74.3,-17.2,75.7,-31.7,70.7C-46.2,65.7,-58.8,54.3,-66.7,40.4C-74.6,26.5,-77.8,10.1,-75.4,-5.3C-73,-20.7,-65,-35.1,-54.1,-46.5C-43.2,-57.9,-29.4,-66.3,-14.8,-69.4C-0.2,-72.5,15.2,-70.3,29.6,-67.1C44,-63.9,25,-68.1,36.8,-60.9Z" transform="translate(100 100)"/></svg>`,
    // Schweiz — Swiss cross
