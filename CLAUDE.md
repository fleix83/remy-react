...
- [x] **H2 — Google Fonts loaded from Google's CDN.** Fixed 2026-09-18: fonts are self-hosted (`src/fonts.css`, `public/fonts/*.woff2`, latin + latin-ext subsets) and the Google hosts were dropped from the CSP in `.htaccess`.
